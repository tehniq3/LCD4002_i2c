...
//  lcd.clear(1);
  lcd.setCursor(0, 0);
  lcd.print("adjustable RTC clock on LCD4002 display ");
  lcd.setCursor(0, 1);
  lcd.print("sw v.2.0 wrote by Nicu FLORICA (niq_ro) ");
